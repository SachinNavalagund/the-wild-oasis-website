      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            ...
            home. But it&apos;s not just about the luxury cabins.
            It&apos;s about the experience of reconnecting with
            nature and enjoying simple pleasures with family.
          </p>
          <p>
            Our {cabins.length} luxury cabins provide a cozy
            base, but the real freedom and peace you&apos;ll find
            in the surrounding mountains. Wander through lush
            forests, breathe in the fresh air, and watch the
            stars twinkle above from the warmth of a campfire or
            your hot tub.
          </p>
          <p>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            ...
            haven has been nurtured with love and care, passing
            down through our family as a testament to our
          ...
          <p>
            ...
            join us at The Wild Oasis soon, where tradition meets
